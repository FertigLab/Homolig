...
df['C1_sil_score'] = silhouette_samples(x, df['C1'])
df['C2_sil_score'] = silhouette_samples(x, df['C2'])
df['C3_sil_score'] = silhouette_samples(x, df['C3'])
df['C4_sil_score'] = silhouette_samples(x, df['C4'])
